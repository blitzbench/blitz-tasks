...
/**
 * @brief Metal runner for gpu_matmul_fp16. Built only on Apple platforms; the lib target
 *        sets GPU_MATMUL_FP16_HAVE_METAL which gates inclusion from the task's
 *        dispatch().
 *
 * @param setup
