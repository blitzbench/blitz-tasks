...
/**
 * @file kernels.hpp
 * @brief Per-tier integer throughput kernel wrappers for cpu_int_multi.
 *
 ...
 * reports i32 (see cpu_int_multi.cpp), the other widths exist for parity and
 ...
 * dispatch table in cpu_int_multi.cpp must wire slots under the same guards.
 */
