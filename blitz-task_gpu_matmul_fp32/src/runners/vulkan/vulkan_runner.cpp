...
bool build_context(const gpgpu::vendor::VulkanFns& vk, const gpgpu::Setup& setup, std::uint32_t n,
  ...
  if (!create_buffer(vkd, out.dev, mp, elems * 4, VK_BUFFER_USAGE_STORAGE_BUFFER_BIT, local, out.a) ||
      !create_buffer(vkd, out.dev, mp, elems * 4, VK_BUFFER_USAGE_STORAGE_BUFFER_BIT, local, out.b) ||
